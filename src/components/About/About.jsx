    ...
    professionalJourney: [
      {
        ...
        image: "/public/images/aishwi_technologies_logo.jpeg",
      },
      {
        ...
        image: "/public/images/unifiedmentor.png",
        reverse: true,
      },
    ],
    projects: [
    ...
    <div className="py-16 bg-gradient-to-r from-black to-gray-800 text-gray-200">
      <div className="container mx-auto px-8 lg:px-16">
        ...
        {renderSection(
          ...
          "/public/images/sunilrathod2.jpg"
        )}
        <br />
        {renderSection(
          "Education",
          aboutMe.education,
          "/public/images/educationimage.jpeg",
          true
        )}
        <br />
        <br />
        ...
        {renderSection(
          "Mission",
          aboutMe.mission,
          "/public/images/missionimage.jpg",
          true
        )}
        <br />
